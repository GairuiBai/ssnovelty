...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='CIFAR10', help='folder|CIFAR10|Caltech256')
        ...
        self.parser.add_argument('--normalclass', type=int, default=0, help='class type number')
        self.parser.add_argument('--outclassnum', type=int, default=4, help='class type number')
